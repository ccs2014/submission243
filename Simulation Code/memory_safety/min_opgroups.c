...
/*  opgroups  */
#define move 0x01
#define move_care 0x0c
#define move_rescare 0x02

#define arith2s1d 0x03
#define arith2s1d_care 0x0e
#define arith2s1d_rescare 0x02

#define arith1s1d 0x04
#define arith1s1d_care 0x0c
#define arith1s1d_rescare 0x02

#define arith1d 0x05
#define arith1d_care 0x08
#define arith1d_rescare 0x02

#define wload 0x06
#define wload_care 0x0d // 1101
#define wload_rescare 0x02

#define bload 0x07
#define bload_care 0x0d
#define bload_rescare 0x02

#define wstore 0x08
#define wstore_care 0x0b
#define wstore_rescare 0x01

#define bstore 0x09
#define bstore_care 0x0b
#define bstore_rescare 0x01

#define cbranch 0x0a
#define cbranch_care 0x08
#define cbranch_rescare 0x00

#define ubranch 0x0a
#define ubranch_care 0x08
#define ubranch_rescare 0x00

#define ijump 0x0a
#define ijump_care 0x08
#define ijump_rescare 0x00

#define dcall 0x0a
#define dcall_care 0x08
#define dcall_rescare 0x00

#define icall 0x0a
#define icall_care 0x08
#define icall_rescare 0x00

#define ret 0x0a
#define ret_care 0x08
#define ret_rescare 0x00

#define other 0x0f
#define other_care 0x08
